...
public class MySurfaceView extends SurfaceView implements Callback, Runnable {
        ...
        switch (event.getAction() & 255) {
            ...
            case XMLTableColumnDefinition.STRING_TYPE:
                ...
                if (this.list1.size() == 0 && this.list2.size() == 0) {
                    ...
                    bundle.putParcelableArrayList("list1", (ArrayList<? extends android.os.Parcelable>) this.list1);
                    bundle.putParcelableArrayList("list2", (ArrayList<? extends android.os.Parcelable>) this.list2);
    ...
    private void drawBackground() {
        ...
        Log.w("清空画布drawBackground,clie", new StringBuilder(String.valueOf(getWidth())).append("×")
                .append(getHeight())
                .toString());
